...
weights = [
    np.array([[-2.54942087], [-7.34844221], [5.66564003], [9.53355062], [-7.01508122]]),
    np.array(
        [
            [-0.17622762, 6.46607767, -1.73403919, -9.8232896, 5.05751039],
...
biases = [
    np.array(
        [[-3.12784542], [12.21773855], [-2.29184127], [-18.85043553], [7.82582976]]
    ),
...
predictions = np.array(
    [mlp_square_2_5.feedforward(x.reshape(-1, 1))[0] for x in X_test_square]
)
...
weigths = [
    np.array(
        [[68.92862219], [-84.99513297], [119.23495792], [76.89301184], [-87.21358006]]
    ),
    np.array(
        [
            [1.91289906, -0.42319819, 18.07070798, 3.00123577, -1.92057603],
            ...
            [13.95014667, -2.87680419, -4.92717336, 15.68627572, -2.98792556],
        ]
    ),
    np.array([[44.09132003, 45.01472659, 40.25650334, -74.36851247, 39.73410003]]),
]
...
biases = [
    ...
    np.array(
        [[-5.82400193], [-7.63091442], [-1.24066723], [-14.10986627], [-10.58238982]]
    ),
    np.array([[-9.09792412]]),
]
...
# Generate predictions
predictions = np.array(
    [mlp_steps_2_5.feedforward(x.reshape(-1, 1))[0] for x in X_test_steps]
)
