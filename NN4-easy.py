...
df_train_rings = pd.read_csv("mio1/classification/easy-training.csv")
...
df_test_rings = pd.read_csv("mio1/classification/easy-test.csv")
...
mlp = MLP(layer_sizes=[2, 5, 2], verbose=False)
