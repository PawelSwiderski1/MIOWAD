...
class MLP:
    def __init__(self, layer_sizes, verbose=False):
        ...
        # Decided to use xavier method for initialization
        self.weights = [
...
mlp_square_1_5 = MLP([1, 10, 10, 5, 1], verbose=False)
training_data_scaled = [
    (x.reshape(-1, 1), y) for x, y in zip(X_train_scaled, y_train_scaled)
]
mlp_square_1_5.train(
    training_data_scaled, epochs=200, learning_rate=0.1, batch_size=10, plot_interval=20
)
